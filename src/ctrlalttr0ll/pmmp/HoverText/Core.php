...
use ctrlalttr0ll\pmmp\HoverText\command\TxtCommand;
...
use ctrlalttr0ll\pmmp\HoverText\task\CheckUpdateTask;
use ctrlalttr0ll\pmmp\HoverText\task\PrepareTextsTask;
...
class Core extends PluginBase implements Listener {
  ...
  private function checkPackaged(): bool {
    ...
    $logger = $this->getLogger();
    if ($this->isPhar()) {
      if (class_exists("\\ctrlalttr0ll\\pmmp\\HoverText\\libs\\jojoe77777\\FormAPI\\FormAPI")) {
